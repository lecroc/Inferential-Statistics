...
I want to discover which regions have significant differences so I will run a t-test on all possible combinations of regions, using the bonferoni correction to control for type 1 errors.
...
combo<-c("New England V Middle Atlantic", "New England V East North Central",
         "New Enegland V West North Central", "New England V South Atlantic",
         "New England V East South Central", "New England V West South Central",
         "New England V Mountain", 'New England V Pacific',
         "Middle Atlantic V East North Central", "Middle Atlantic V West North Central",
         "Middle Atlantic V South Atlantic", "Middle Atlantic V East South Central",
         "Middle Atlantic V West South Central", "Middle Atlantic V Mountaih",
         "Middle Atlantic V Pacific", "East North Central V West North Central",
         "East North Central V South Atlantic", "East North Central V East South Central",
         "East North Central V West South Central", "East North Central V Mountain",
         "East North Central V Pacific", "West North Central V South Atlantic",
         "West North Central V East South Central", 
         "West North Central V West South Central",
         "West North Central V Mountain", "West North Central V Pacific",
         "South Atlantic V East South Central", "South Atlantic V West South Central",
         "South Atlantic V Mountain", "South Atlantic V Pacific",
         "East South Central V West South Central", "East South Central V Mountain",
         "East Sourth Central V Pacific", "West South Central V Mountain",
         "West South Central V Pacific", "Mountain V Pacific")
...
### Results of Region by Region t-tests
